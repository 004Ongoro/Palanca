        ...
        <div style="font-family: 'Segoe UI', sans-serif; background-color: #fefefe; padding: 20px; color: #333;">
          <div style="max-width: 600px; margin: 0 auto; border-radius: 10px; background: #fff; box-shadow: 0 0 10px rgba(0,0,0,0.1); overflow: hidden;">
            ...
            <div style="padding: 20px;">
              ...
              <p>We’ve received your booking and our team is reviewing it. You will receive a follow-up shortly. Below are your booking details:</p>
              ...
              <div style="margin-top: 30px; text-align: center;">
                <a href="https://palanca-kohl.vercel.app" style="background: #7ec8c8; color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; margin: 5px;">Visit Our Site</a>
                <a href="mailto:reservations@palancasafari.com" style="background: #ffe0b2; color: #333; padding: 10px 20px; border-radius: 6px; text-decoration: none; margin: 5px;">Contact Us</a>
              </div>

              <p style="margin-top: 30px;">If any information is incorrect, contact us at <a href="mailto:reservations@palancasafari.com">reservations@palancasafari.com</a>.</p>
            </div>
